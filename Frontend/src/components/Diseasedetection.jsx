...
const Diseasedetection = () => {
  ...
  // Define slide-in animation variants for different screen sizes
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-3 md:p-6">
      <div
        ref={ref}
        className="w-full max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-40 p-6 md:p-10"
      >
        ...
        >
          <img
            src="/image/disease.png"
            alt="Disease Detection"
            className="w-full h-auto md:h-56 object-cover rounded-xl"
          />
        </motion.div>

        {/* Text Section (Has Background Image in Mobile) */}
        <motion.div
          ...
          bg-[url('/image/disease.png')] bg-cover bg-center md:bg-none"
          variants={slideInRightVariant}
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          exit="exit"
        >
          <h2 className="text-2xl md:text-4xl font-bold text-green-500 mb-4 text-center md:text-left" 
            style={{ textShadow: '2px 2px 0 #000, -2px -2px 0 #000, 2px -2px 0 #000, -2px 2px 0 #000' }}>
            Disease Detection
          </h2>

          <p className="text-white leading-relaxed text-sm md:text-lg mb-6">
            To detect diseases in plants, we use machine learning algorithms.
          </p>
