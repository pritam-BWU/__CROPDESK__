...
const Fertilizer = () => {
  ...
  return (
    <div className="flex items-center justify-center p-4 md:p-6 mb-6 md:mb-0">
      <div
        ref={ref}
      ...
      >
        ...
        <motion.div
          ...
          bg-[url('/image/ferl.png')] bg-cover bg-center md:bg-none"
        ...
        >
          ...
          <p className="text-white leading-relaxed text-sm md:text-lg mb-6">
            Capable of detecting the required fertilizer in the soil using
